...
| OBE core | Lifecycle kurikulum maker-reviewer-approver-activator, paket JSON/CSV ber-checksum, seed exact 5/12/18/31/77, weighted trace dua arah, progress/equivalence, registry 11 rule dan 2 package cohort, decision/replay, override/banding, integrity gate, RPS, asesmen, evidence, attainment, CQI | Keputusan Prodi atas 129 SKS wajib dan CPMK22/CPMK27 tanpa mapping, UAT workflow penuh, golden calculation institusi, rekonsiliasi SIA |
