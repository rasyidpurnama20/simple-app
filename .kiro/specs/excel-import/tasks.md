...
- [ ] 1. Scaffold `excel_import` app, data models, and shared error infrastructure
  - [ ] 1.1 Create the `excel_import` Django app skeleton
  ...
  - [ ] 1.2 Implement `ImportBatch`, `StagedRow`, `TemplateDefinition` models
  ...
  - [ ] 1.3 Generate initial migrations
    - Run `makemigrations` for the `excel_import` app and verify the migration applies cleanly
    - _Requirements: 9.4_

  - [ ] 1.4 Implement `DomainError` hierarchy and plain-language message catalog
  ...
  - [ ]* 1.5 Write property test for actionable, jargon-free messages
  ...
  - [ ]* 1.6 Write unit tests for model constraints
...
- [ ] 2. Implement TemplateRegistry over versioned definitions
  - [ ] 2.1 Seed declarative `TemplateDefinition`s and implement `TemplateRegistry`
  ...
  - [ ]* 2.2 Write property test for deferred-type rejection
  ...
  - [ ]* 2.3 Write property test for definition history and completeness
  ...
  - [ ]* 2.4 Write example tests for registry contents
...
- [ ] 3. Implement deterministic TemplateGenerator
  - [ ] 3.1 Build the five fixed-order sheets and embedded identity
  ...
  - [ ] 3.2 Implement byte-stable output normalization
  ...
  - [ ]* 3.3 Write property test for generation determinism
    - **Property 4: Generation determinism** — generating twice from identical inputs yields byte-identical output
    - **Validates: Requirements 2.4**

  - [ ]* 3.4 Write property test for workbook structure and formula-freedom
  ...
  - [ ]* 3.5 Write property test for embedded identity round-trip
...
- [ ] 5. Implement ScopeResolver and prefill via service layer
  - [ ] 5.1 Implement `ScopeResolver` resolve/reference/prior-data methods
  ...
  - [ ]* 5.2 Write property test for timeline scope prefill
  ...
  - [ ]* 5.3 Write property test for reference and prior-data prefill
...
- [ ] 6. Implement FileValidator safety pipeline
  - [ ] 6.1 Implement the ordered upload safety pipeline
  ...
  - [ ]* 6.2 Write property test for unsafe-upload rejection
  ...
  - [ ]* 6.3 Write edge-case tests for size boundary and malformed content
...
- [ ] 7. Implement StagingArea and DryRunValidator
  - [ ] 7.1 Implement `StagingArea` parse-and-persist
  ...
  - [ ] 7.2 Implement `DryRunValidator` classification and reporting
  ...
  - [ ]* 7.3 Write property test for dry-run no-writes
  ...
  - [ ]* 7.4 Write property test for validate-and-classify-once and duplicates
  ...
  - [ ]* 7.5 Write property test for schema-version mismatch rejection
...
- [ ] 9. Implement CommitEngine (atomic, idempotent)
  - [ ] 9.1 Implement single-transaction, business-key upsert commit
  ...
  - [ ]* 9.2 Write property test for commit atomicity
  ...
  - [ ]* 9.3 Write property test for idempotent upsert
  ...
  - [ ]* 9.4 Write property test for reconciliation conservation and readiness fields
...
- [ ] 10. Implement ExcelImportService facade and lifecycle state machine
  - [ ] 10.1 Implement the transport-agnostic facade and status transitions
  ...
  - [ ]* 10.2 Write property test for lifecycle transition and status validity
...
- [ ] 11. Implement thin HTMX views and URL wiring
  - [ ] 11.1 Implement generate/download, upload+dry-run, and commit views
...
- [ ] 12. Integration, boundary, and smoke tests
  - [ ]* 12.1 Write end-to-end single-request loop test
  ...
  - [ ]* 12.2 Write service-layer boundary and migration-drift tests
