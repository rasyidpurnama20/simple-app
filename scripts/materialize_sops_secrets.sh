...
output_directory="$3"
case "$profile" in
  staging|production) mappings=(database_url:database_url database_password:database_password django_secret_key:obe_secret_key litellm_api_key:litellm_api_key rabbitmq_password:rabbitmq_password rabbitmq_url:rabbitmq_url) ;;
